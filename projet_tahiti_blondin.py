...
def load_data(nrows, filename, number):
    ...
    data=pd.read_csv("https://jtellier.fr/DataViz/full_" + filename + ".csv",nrows=number,usecols=req_col,parse_dates=['date_mutation'],dtype={("nature_mutation ","nom_commune","nature_culture"):"category",("valeur_fonciere","surface_relle_bati","nombre_pieces_principales","surface_terrain","longitude","latitude","code_postal") : "float32"})
